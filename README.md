# Magnesis
> 🌎 Библиотека для анализа и прогнозирования магнитной активности Земли на основе данных солнечного ветра и геомагнитных индексов с применением нейронной сети GeomagneticNet для многомерного временного прогнозирования.
